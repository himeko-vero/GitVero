...
public class Administrador extends Usuario {
	...
	joinColumns={@JoinColumn(name="NUMERO_DOCUMENTO"), @JoinColumn(name="TIPO_DOCUMENTO")}, //Hay que hacerlo así puesto que la clave de administrador está formada por dos atributos
